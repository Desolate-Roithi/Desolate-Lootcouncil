...
L["3x Tokens"] = true
L["Add 3x Tier Tokens"] = true
L["Stages 3 identical tier tokens into the backlog with distinct GUIDs to verify multi-token handling, independent voting, and pending trade distinction."] = true
L["Added %d duplicate tier tokens to the loot backlog."] = true
L["Monitor UI"] = true
