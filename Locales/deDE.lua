...
L["Could not stage item for %s: missing itemID."] = "Konnte Gegenstand für %s nicht bereitstellen: itemID fehlt."
L["Item not found in bags."] = "Gegenstand nicht in den Taschen gefunden."
L["Item is soulbound and cannot be traded (trade timer expired or not tradeable)."] = "Gegenstand ist seelengebunden und kann nicht gehandelt werden (Handelszeit abgelaufen oder nicht handelbar)."
L["Item is Warbound (account-bound) and cannot be traded."] = "Gegenstand ist kriegsmeutegebunden (accountgebunden) und kann nicht gehandelt werden."
L["Item bag slot is locked."] = "Taschenplatz des Gegenstands ist gesperrt."
...
L["3x Tokens"] = "3x Tokens"
L["Add 3x Tier Tokens"] = "3x Tier-Tokens hinzufügen"
L["Stages 3 identical tier tokens into the backlog with distinct GUIDs to verify multi-token handling, independent voting, and pending trade distinction."] = "Fügt 3 identische Tier-Tokens mit eindeutigen GUIDs zum Backlog hinzu, um Multi-Token-Handling, unabhängiges Abstimmen und Handelsunterscheidung zu prüfen."
L["Added %d duplicate tier tokens to the loot backlog."] = "%d doppelte Tier-Tokens zum Beute-Backlog hinzugefügt."
